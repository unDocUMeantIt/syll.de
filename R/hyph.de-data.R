...
#' 
#' Hyphenation patterns for German to be used by \code{\link[sylly:hyphen]{hyphen}}.
...
#' \dontrun{
#' library(sylly.de)
#' sampleText <- c("Dies","ist","ein","ziemlich","dummes","Beispiel")
#' hyphen(sampleText, hyph.pattern="de")
#' }
NULL
